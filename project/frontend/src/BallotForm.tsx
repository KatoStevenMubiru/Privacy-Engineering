...
export class IBallotForm extends React.PureComponent<{}, IBallotFormState> {
  ...
  public render() {
    ...
    /* TODO: 
     *  1. Somewhere in the object returned below, we should be including language about voter secrecy, 
     *     and a voter's right to deregister after voting to protect their data
     *  2. Additionally, we should be informing the voter that they shouldn't include any personally identifiable 
     *     information in the "comment" section, as it risks compromising their voter secrecy
    ...
    <>
      <FormGroup>
        ...
        {/* Add a message about voter secrecy and deregistration */}
        <p className="white-text">After verifying your identity, your vote will be counted anonymously.</p>
        ...
        <br />
        {/* Add a message about not including personally identifiable information */}
        <p className="white-text">Do not put any information identifying yourself or others in the "comments" section.</p>
